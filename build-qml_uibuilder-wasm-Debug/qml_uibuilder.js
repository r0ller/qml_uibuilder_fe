...
var STATIC_BASE = 1024,
    ...
    STACKTOP = STACK_BASE,
    STACK_MAX = 8863712,
    DYNAMIC_BASE = 14106592,
    DYNAMICTOP_PTR = 8863536;
...
var wasmBinaryFile = 'qml_uibuilder.wasm';
...
var ASM_CONSTS = {
  1033: function($0) {uibuilder.onChange('msg',function(msg){ console.log(msg); let strmsg=JSON.stringify(msg); dynCall('vi',$0,[allocate(intArrayFromString(strmsg),'i8',ALLOC_NORMAL)]); });},  
 1397: function($0) {uibuilder.send({'topic':'from-the-front','payload':UTF8ToString($0)});}
};
...
// {{PRE_LIBRARY}}
  ...
  var _fetch_work_queue=8863696;function __emscripten_get_fetch_work_queue() {
  ...
  var ___tm_current=8863552;
  
  
  var ___tm_timezone=(stringToUTF8("GMT", 8863600, 4), 8863600);
