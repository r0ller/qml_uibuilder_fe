...
#Uncomment for __NODEJS__ build targeting NodeRED:
#LIBS += -L../../emsdk/upstream/emscripten/src -lwebsocket.js
#-lsocket.io.js -luibuilderfe.min.js
INCLUDEPATH += ../../emsdk/upstream/emscripten/system/include/emscripten
